...
def get_crypto_data(
    ...
    try:
        ...
        twitter_followers = cd.get("twitter_followers", "N/A") # Often deprecated in public API, but check
        ...
        if sentiment_up and sentiment_down:
             report.append(f"- **CoinGecko User Sentiment**: 👍 {sentiment_up}% / 👎 {sentiment_down}%")
