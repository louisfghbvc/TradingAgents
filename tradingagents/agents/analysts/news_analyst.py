...
def create_news_analyst(llm):
    def news_analyst_node(state):
        ...
        system_message = (
            ...
            + "IMPORTANT: When using your internal search capabilities or the provided tools, ensure you find and cite at least 5 distinct news articles or sources to support your analysis. "
